...
class DESTests {
    ...
    @Test
    void DESCFB8PKCS5Encrypt(FxRobot robot) {
        /* select ECB Mode of Operation */
        robot.clickOn("#DesModeOfOperationComboBox");
        robot.clickOn("CFB8");
        ...
        /* verify if encryption was successful */
        FxAssert.verifyThat("#DesOutputTextArea", TextInputControlMatchers.hasText("5679535718144520e5c0add3ad86f4f4"));
    }

    @Test
    void DESCFB8DecryptNoPadding(FxRobot robot) {
        /* select ECB Mode of Operation */
        robot.clickOn("#DesModeOfOperationComboBox");
        robot.clickOn("CFB8");
        ...
        /* write input */
        robot.clickOn("#DESInputTextArea").write("5679535718144520");
    ...
    @Test
    void DESOFB8PKCS5Encrypt(FxRobot robot) {
        /* select ECB Mode of Operation */
        robot.clickOn("#DesModeOfOperationComboBox");
        robot.clickOn("OFB8");
        ...
        /* verify if encryption was successful */
        FxAssert.verifyThat("#DesOutputTextArea", TextInputControlMatchers.hasText("5679535718144520e5106713d9eb2ae7"));
    }

    @Test
    void DESOFB8DecryptNoPadding(FxRobot robot) {
        /* select ECB Mode of Operation */
        robot.clickOn("#DesModeOfOperationComboBox");
        robot.clickOn("OFB8");
    ...
    @Test
    void DESOFB8PKCS5Decrypt(FxRobot robot) {
        /* select ECB Mode of Operation */
        robot.clickOn("#DesModeOfOperationComboBox");
        robot.clickOn("OFB8");
        ...
        /* write input */
        robot.clickOn("#DESInputTextArea").write("5679535718144520e5106713d9eb2ae7");
